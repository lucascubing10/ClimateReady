      ...
      >
        ...
        >
          ...
          <View style={styles.formContainer}>
            <View style={styles.formContainerToReduceWidth}>
          ...
          <View style={[styles.formContainer, { marginTop: 16, marginBottom: 18, borderLeftWidth: 2.5, borderLeftColor: '#6c757d' }]}>
